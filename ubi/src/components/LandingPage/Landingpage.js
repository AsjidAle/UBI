                ...
                <Container className="px-sm-0">
                  <Row>
                    ...
                    <Col xl={6} lg={6} className="my-auto">
                      {/* <img src={require("../../assets/landing/images/market3.jpeg")} alt="market" /> */}
                    </Col>
                  </Row>
                </Container>
              </div>
                          ...
                          <Card className="features main-features main-features-1 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              ...
                              <div className="text-left counter-body">
                                ...
                                <p className="mb-0">UBI has a unique design that you cannot compare
                                  with any other platform. It has unique Design</p>
                              </div>
                            </Card.Body>
                          </Card>
                        </Col>
                          ...
                          <Card className=" features main-features main-features-2 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              ...
                              <div className="text-left counter-body">
                                ...
                                <p className="mb-0">The UBI admin is well maintaining and monitoring
                                  structure and services being offered on UBI.</p>
                              </div>
                            </Card.Body>
                          </Card>
                        </Col>
                        <Col lg={3} md={12}>
                          <Card className="features main-features main-features-3 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              ...
                              <div className="text-left counter-body">
                                <h4 className="fw-bold">Multiple Roles</h4>
                                <p className="mb-0">
                                  We included multiple roles, preview , and screen shots to
                                  give a quick overview of our Dashboard for any admin.
                                </p>
                              </div>
                            </Card.Body>
                          </Card>
...
C431.3,1830.2,378.4,1777.3,378.4,1712z" />
                        ...
                        <Card className=" bg-transparent mb-0">
                          ...
                          <div className="demo-screen-skin code-quality" id="dependencies">
                            <div className="text-center p-0">
                              <h2 className="text-center fw-semibold text-white">Benifits of
                                UBI Products</h2>
                        ...
                        <section className="sptb demo-screen-demo" id="highlights">
                          <Container>
                            <Row className="align-items-center">
                              ...
                              <span className="landing-title"></span>
                              <h2 className="text-center fw-semibold">FAQ Highlights</h2>
                              <Col lg={12}>
                                <h6 className="text-default sub-text mb-5 text-center">
                                  Here is the highlights of Frequently Asked Questions (FAQs).
                                </h6>
                                {/* collapse */}
                                <Row id="grid">
                                  <Col lg={6}>
                                      ...
                                      <Card className=" bg-primary-transparent bg-transparent border p-0 reveal">
                                        <Card.Header className="grid-link " onClick={() => { Firstcollapse("primary") }}>
                                          <Card.Subtitle
                                            ...
                                            How can farmers benefit from using this app?</Card.Subtitle>
                                        </Card.Header>
                                        {isFirstCollapsed ? (
                                          <Card.Body className="pt-0">
                                            <p>
                                              Farmers can sell their crops directly to buyers, reaching a wider market and getting
                                              fair prices for their produce. They can also access useful information and resources
                                        ...
                                        >
                                          <Card.Subtitle
                                            ...
                                            <span className="card-controls">
                                              ...
                                              <span className="shrink"><i
                                                className="fe fe-minus"></i></span>
                                            </span>How does the export process work?</Card.Subtitle>
                                        </Card.Header>
                                        {is2Collapsed ? (
                                          <Card.Body className="pt-0">
                                            <p className="mb-3">
                                              Exporters can browse through the available products on the platform and place orders
                                              for the ones they want to buy. The platform facilitates communication and transactions
                                              between exporters and farmers, making the export process smoother.
                                            </p>
                                          </Card.Body>
                                        ) : null}
                                      </Card>
                                        ...
                                        >
                                          <Card.Subtitle
                                            ...
                                            <span className="card-controls">
                                              ...
                                              <span className="shrink"><i
                                                className="fe fe-minus"></i></span>
                                            </span>How do I get paid for my products?</Card.Subtitle>
                                        </Card.Header>
                                        {is3tCollapsed ? (
                                          <Card.Body className="pt-0">
                                            <p className="mb-3">
                                              Payments are typically processed securely through the platform. Once a transaction
                                              is completed, the payment is transferred to the seller's account, ensuring a smooth
                                              and transparent payment process.</p>
                                          </Card.Body>
                                        ) : null}
                                      </Card>
                                    </Col>
                                        ...
                                        >
                                          <Card.Subtitle
                                            ...
                                            <span className="card-controls">
                                              ...
                                              <span className="shrink"><i
                                                className="fe fe-minus"></i></span>
                                            </span>Can I track the status of my Orders?</Card.Subtitle>
                                        </Card.Header>
                                        {is4Collapsed ? (
                                          <Card.Body className="pt-0">
                                            <p>
                                              Yes, the platform provides tracking features that allow users to monitor the status
                                              of their shipments in real-time. This helps ensure timely delivery and allows for
                                              better coordination between farmers, exporters, and logistics providers.
                                            </p>
                                          </Card.Body>
                                        ) : null}
                                      </Card>
                                        ...
                                        >
                                          <Card.Subtitle to="#"
                                            ...
                                            <span className="card-controls">
                                              ...
                                              <span className="shrink"><i
                                                className="fe fe-minus"></i></span>
                                            </span>Is there customer support available?</Card.Subtitle>
                                        </Card.Header>
                                        {is5Collapsed ? (
                                          <Card.Body className="pt-0">
                                            <p>
                                              Yes, customer support is available to assist users with any questions or issues they may
                                              encounter while using the platform. Users can reach out for help via email, phone, or
                                              through the app's messaging system. </p>
                                            ...
                                            <Card>
                                              <Card.Body className="p-0">
                                                <div className="counter-status">
                                                  ...
                                                  <h4 className="mb-2 fw-semibold">
                                                    Phone & Email</h4>
                                                  <p className="mb-0">+447827292771 </p>
                                                  <p>ubifarmconnect@gmail.com</p>
                                                </div>
                                              </Card.Body>
                                            </Card>
                                          </Col>
                  ...
                  <div className="demo-screen-skin" style={{ backgroundColor: '#22B14C' }}>
                      ...
                      <Row id="demo">
                        <Col lg={6}>
                          <div className="feature-1 border-0"> <Link to="#"></Link>
                            ...
                            <h6 className="mb-0">Support : <Link to="mailto:ubifarmconnect@gmail.com" className="text-white pos-relative"
                            >ubifarmconnect@gmail.com</Link></h6>
                          </div>
                        </Col>
                        <Col lg={6} className=" mt-5 mt-xl-0 mt-lg-0">
                          <div className="feature-1 border-0"> <Link to="#"></Link>
                            ...
                            <p className="mb-1 text-white">Please feel free to ask any questions before making
                              the purchase.</p>
                            <h6 className="mb-0">Ask : <Link to="mailto:ubifarmconnect@gmail.com" className="text-white pos-relative"
                            >ubifarmconnect@gmail.com</Link>
                            </h6>
                          </div>
                        </Col>
                      </Row>
